...
def gerar_contrato():
    ...
    p_assinaturas = doc.add_paragraph()
    p_assinaturas.add_run("__________________________________________\n\n")

    p_assinaturas = doc.add_paragraph()
    p_assinaturas.add_run("PP: Tereza Maria Cardoso da Silva                      Locatário: ")
    p_assinaturas.add_run(nome_locatario)
    p_assinaturas.add_run("\n\n")
